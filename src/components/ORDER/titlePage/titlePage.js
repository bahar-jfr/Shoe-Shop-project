...
export function TitlePage() {
  return El({
    element: "div",
    className: "flex justify-between items-center py-6 mb-3 px-2",
    children: [
      El({
        element: "div",
     ...
     El({
        ...
        children:[
            El({
              ...
              El({
                element:"span",
                innerHTML: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.3"><path d="M12 12.25v-.5m4 .5v-.5m-8 .5v-.5"/><circle cx="12" cy="12" r="9"/></g></svg>`
              })
        ]
     })
    ],
